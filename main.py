...
def get_args():
    ...
    #Model related
    parser.add_argument('--load-model-directory', "-dirm", type=str, default="output", help='This is where model is/will be located...')  
...
if __name__ == "__main__":
    ...
    #[Dec 19th 2023] git pull && python -m main --ngpus "auto" --accelerator gpu --strategy none -b 512 
    #[Dec 30th 2023] git pull && python -m main --ngpus "auto" --accelerator gpu --strategy none -b 512 --finetune --loss_weights 0 1 0
