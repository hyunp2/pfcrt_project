...
if __name__ == "__main__":
    ...
    #[Dec 30th 2023] git pull && python -m main --ngpus "auto" --accelerator gpu --strategy none -b 512 --finetune --loss-weights 0 1 0 --load_model_directory output_finetune --load_model_checkpoint best_pretrained.ckpt
