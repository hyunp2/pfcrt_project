...
def get_args():
    ...
    parser.add_argument('--nonuniform-weight', type=bool, default=True, help='Weighted CE loss')
    parser.add_argument('--use-ce', type=bool, default=True, help='CE vs Focal loss')
